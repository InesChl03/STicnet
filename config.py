...
data_config = {
    ...
    'data_dir': '/home/inas/data/luna16/LUNG16',
    # put lung mask downloaded from LUNA16 to this path
    'lung_mask_dir': '/home/inas/data/luna16/seg-lungs-LUNA16',
    # directory for putting all preprocessed results for training to this path
    'preprocessed_data_dir': '/home/inas/data/luna16/preprocessed',
    ...
    'annos_save_dir': '/home/inas/data/luna16/preprocessed',
}
